...
parsing = html.find_all('tr')[1:3]
day_menu=[]
menu_lunch_data = [i.find_all('td',{'class':'mon'}) for i in parsing]
menu_lunch_data2=[html.select(".foodmenu")[i].get_text() for i in range(0,5)] # Put in menu_lunch_data in html-> 'class==foodmenu'
